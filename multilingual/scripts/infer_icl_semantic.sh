...
case "$TEST_DATASET_NAME" in
    "conll14")
        python evaluators/m2scorer/scripts/m2scorer.py --verbose ${RESULT_DIR}/conll14/conll14.txt ${DATASETS_DIR}/multilingual_raw/EN-conll14st-test-data/noalt/official-2014.combined.m2 | tee ${RESULT_DIR}/conll14/conll14.score
        ;;
    "wilocness")
